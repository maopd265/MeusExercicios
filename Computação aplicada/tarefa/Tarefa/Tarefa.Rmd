...
```{r}
pca = prcomp(dados[,1:16], center=TRUE, scale=TRUE)
print(pca)
```
...
### As variáveis *AspectRation*, *MajorAxisLength*, *Perimeter*, *Eccentricity*, *EquivDiameter*,*ConvexArea*,*Area* e *MinorAxisLength* são as que influenciam mais no componente principal 1. 

### As variáveis *MajorAxisLength*  e *Perimeter* são altamente correlacionadas, pois o ângulo entre elas é muito pequeno.

### AspectRation e Eccentricity são altamente correlacionados, pois o ângulo entre eles é muito pequeno.

### ConvexArea e EquivDiameter são altamente correlacionados, pois o ângulo entre eles é muito pequeno. 

### As variáveis *Extent*, *Roundness*, *ShapeFactor1*, *ShapeFactor2* , *ShapeFactor3* , *ShapeFactor4*, *Solidity*,*AspectRation* são as que influenciam mais no componente principal 2.
